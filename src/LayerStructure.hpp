...
#ifndef SRC_LAYERSTRUCTURE_HPP_
#define SRC_LAYERSTRUCTURE_HPP_
...
public:
	...
	void addDenseLayer(std::vector<Eigen::VectorXd> const &input, std::string const &actFunc, int size);
